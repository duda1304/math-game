                            ...
                            <div className="col-lg-6 d-flex flex-column">
                                <div className="landing-page-signup d-flex flex-column justify-content-center flex-grow-1">
                                    <div className="landing-page-signup-head">
                                        <h1 style={{"color" : "#334"}}>Welcome to math contest!</h1>
                                        <div className="subtitle">
                                            You can compete with you friends                             
                                        </div>
                                    </div>
                                    <div className="landing-page-signup-form flex-fill">
                                        <form id="registration-form" onSubmit={registerSubmit} autoComplete="off">
                                            <div className="step step-2 hide">
                                                {/* <div className="row"> */}
                                                    <div className="col-6">
                                                        <div className="form-group field-register-form-username required">
                                                            <label className="form-label" htmlFor="register-form-username">Choose name</label>
                                                ...
                                                <div className="col-6">
                                                    <div className="form-group field-register-form-password">
                                                        <label className="form-label" htmlFor="register-form-password">Choose password to login to your account from any device</label>
                                                ...
                                                {/* <div className="col-6">
                                                    <div className="form-group field-register-form-password">
                                                        <label className="form-label" htmlFor="register-form-password">If you forget your password what question should we ask you?</label>
                                                        <select className="form-select" aria-label="Default select example" defaultValue="" required name="category" onChange={()=> setDisplayAnswerInput(true) }>
                                                            <option value="" disabled>Select question.....</option>
                                                            <option value="">What is your pet name?</option>
                                                            <option value="">What is the name of street where you live?</option>
                                                            <option value="">What is the name of person you like?</option>
                                                            <option value="">What is the you favourite game?</option>
                                                        </select>
                                                        <div className="help-block"></div>
                                                    </div>                                        
                                                </div> */}
                                                {/* <div className="col-6" display={displayAnswerInput}>
                                                        <div className="form-group field-register-form-question">
                                                            <input type="text" id="register-form-question" className="form-control" name="question" required></input>
                                                            <div className="help-block"></div>
                                                        </div>                                        
                                                </div> */}
                                                {/* <div className="row"> */}
